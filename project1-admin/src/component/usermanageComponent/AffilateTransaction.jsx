...
const AffilateTransaction = ({ id }) => {
  ...
  const getAllTransaction = async () => {
    ...
    }/api/transaction/get-all-transaction-single/${id}?page=${currentPage}&limit=${limit}`;
    try {
...
if (data.length > 0) {
  const payout = data.reduce((acc, transaction) => {
  ...
  return (
    <div className="mt-8 flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <div style={{border:`1px solid ${border}`}} className="border p-2 rounded-lg">
            <p className="font-semibold">Total Payout : <span className="" style={{color:iconColor}}>-{totalPayout} INR</span></p>
        </div>
        ...
        <div className="h-[100%] bg-white rounded-[12px] p-3  w-[100%] ">
          ...
          <table className="w-[100%] ">
            <tr className="text-center p-2   border-b h-[30px] border-gray-600 text-[10px] font-bold ">
              <th className="text-left max-w-[70px]">
                ...
                >
                  ...
                  <td>
                    <div className=" flex justify-center items-center">
                      <Badge style={{ fontSize: "9px" }}>Manual</Badge>
                    </div>
                  </td>
                  ...
                  <td
                    style={{ fontSize: "10px" }}
                    className="text-right max-w-[80px] font-semibold"
                  >
                    {item.admin_response}
                  </td>
                </tr>
      ...
      <div className=" contents lg:hidden pb-4 ">
        <p className=" font-bold text-md mt-8">
          {t(`All`)} {t(`Transactions`)} {t(`Details`)}
        </p>
