...
const LuckySportHistory = () => {
  ...
  const getLuckySportHistory = async () => {
    setLoading(true);
    let url = `${import.meta.env.VITE_API_URL}/api/sport/get-lucky-sport-bet-history?`;
    // if (reportType) {
      ...
      <div>
        ...
        <div className="flex justify-between flex-col gap-4 sm:flex-row  mt-6  pr-5 sm:items-center">
          ...
          >
            ...
            LuckySport {t(`Bet`)} {t(`History`)} <span className={`text-green-600`}></span>
          </p>
                    ...
                    sportData?.map((item) => {
                      return (
                        ...
                        >
                          ...
                          <td
                            className={`font-bold  ${item.profitLoss >= "running"
                                ? "text-orange-400"
                                : item.profitLoss > 0
                                  ? "text-green-600"
                                  : "text-red-600"
...
export default LuckySportHistory;
