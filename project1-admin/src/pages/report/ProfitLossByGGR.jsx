        ...
        <table class="w-full">
          <thead>
            <tr>
              ...
              <th class="px-4 py-2 bg-gray-200">Provider ID</th>
        ...
        >
          ...
          <table className={`w-[100%]  `}>
            ...
            >
              ...
              <th className="min-w-[50px]">{t(`Game`)} {t(`ID`)}</th>
              <th className="min-w-[50px]">{t(`Provider`)} {t(`ID`)}</th>


              <th className="min-w-[50px]">{t(`Display`)} {t(`Name`)}</th>
              <th className="min-w-[50px]">{t(`Partner`)} {t(`Name`)}</th>
              <th className="min-w-[50px]">{t(`Currency`)}</th>
...
{item?.WinLoss=='0'?"-":"+"} {item?.WinLoss=='0'?item?.Amount:item?.WinLoss}
                      ...
                      <td>
                        <div className="flex flex-col items-center justify-center gap-1">
                          <p>{formatDate(item?.BetTime.split(" ")[0])}</p>
