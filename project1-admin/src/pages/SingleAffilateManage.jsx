...
import AllAffilateUser from '../component/usermanageComponent/AllAffilateUser';
import AffilateTransaction from '../component/usermanageComponent/AffilateTransaction';
import AffilateProfile from '../component/usermanageComponent/AffilateProfile';
import Settlement from '../component/usermanageComponent/Settlement';
const SingleAffilateManage = () => {
    ...
    <div className="flex flex-col md:flex-row justify-between mt-4 gap-4 w-[98%] m-auto  ">
        ...
        <div className="flex flex-col-reverse  md:flex-col gap-6">
          ...
          >
            ...
            <div className="grid w-[100%] grid-cols-2 md:grid-cols-1 gap-3">
              <Settlement userData={userData} getData={getUserData} title="admin"/>
      ...
      <div className="w-[95%]  md:w-[90%] mx-auto">
        <div className="w-[100%] flex  bg-[white] rounded-[10px]   justify-between items-center p-1 md:p-3   ">
          ...
          <p style={{color:iconColor}} className={` text-[12px]  md:text-xl font-semibold `}>{t(`Total`)} {t(`Earning`)} :{userData?.amount}</p>
          <p style={{color:iconColor}} className={` text-[12px] font-semibold `}>{t(`Affiliate`)} {t(`code`)} :<Badge colorScheme='green'>{userData?.affiliate_code}</Badge></p>
        ...
        {active === 1 && userData && <AffilateProfile type={"admin"}  userData={userData} />}
         {/* {active === 2 && <Deposit id={userData?.admin_id} />} */}
        {/* {active === 3 && <WithDrawl id={userData?.admin_id} />} */}
        {active === 4 && <AffilateTransaction id={userData?.admin_id} />}
        {/* {active === 5 && <Referral />} */}
        {active === 7 && <BetHistory userData={userData} type="admin"/>} 
        {active===8&&<AllAffilateUser userData={userData} />}
...
export default SingleAffilateManage