...
const getRandomColor = (name) => {
  const colors = [
    "red.500", "orange.500", "yellow.500", "green.500", "teal.500", "blue.500", "cyan.500",
    "purple.500", "pink.500", "linkedin.500", "facebook.500", "messenger.500", "whatsapp.500",
    "twitter.500", "telegram.500"
  ];
  let hash = 0;
...
const AdminManage = () => {
    ...
    <div className="px-2 lg:px-0">
      <div className="flex flex-col items-end gap-3 md:flex-row justify-between px-2">
        <div className="flex items-center md:w-[60%] gap-2">
          <div style={{ border: `1px solid ${border}`, backgroundColor: primaryBg }} className={` justify-between rounded-[8px] pl-1 flex items-center gap-2 w-[100%]`}>
            <input
  ...
  <option value={ele}>{t(ele)}</option>
          ...
          <select
            ...
            value={status}
            style={{ border: `1px solid ${border}`, backgroundColor: primaryBg }} className={` p-[8px]   w-[100%] rounded-[6px] text-xs md:text-sm font-semibold border outline-none `}>
            <option>
              {" "}
      ...
      <div className="flex justify-between flex-col gap-4 sm:flex-row  mt-6  pr-5 sm:items-center">
        ...
        <p style={{ color: iconColor }} className={`font-bold mt-6  w-[100%]    flex items-center gap-2 rounded-[6px]  text-lg`}>
          ...
          {t(`Admin Manage`)} <span className={`text-green-600`}>( {adminCount?.totalAdminCount})</span>
                ...
                <div className="rounded-[10px] flex justify-between  overflow-scroll items-center gap-3 bg-white p-2 w-[100%]">
                  <div className="flex items-center min-w-[150px] w-[100%] gap-1">
                    <Avatar
                      ...
                      bg={getRandomColor(item?.username)}
                      color="white"
                  ...
                  <div className="flex min-w-[180px] w-[100%] flex-col gap-1">
                    ...
                    <p className="text-xs flex  font-medium  ">
                      ...
                      <span className="text-[10px] font-bold">({time24Hour})</span>
                    </p>
                  </div>
                  ...
                  {(check1 || check) && <div className="flex items-center justify-end min-w-[120px] gap-[8px]">
                    {check1 && <Link
                    ...
                    {check1 && <ChangePassword id={item.admin_id} type="admin" userName={item?.username} />}
      ...
      <div>
        {allAdminData?.length === 0 ? <div className="flex justify-center items-center"><img src={nodatafound} className="w-[300px] rounded-[50%]" alt="No user found" /></div> : ""}
      </div>
