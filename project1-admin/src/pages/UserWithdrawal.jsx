      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  justify-between  gap-6 w-[100%]">
        ...
        >
          ...
          <div className="flex flex-col items-start justify-evenly mt-4 w-[90%] m-auto">
            <p className="font-extrabold text-2xl   text-red-500 w-[100%]"> &#x20B9; - {transactionData?.totalWithdrawAmount} </p>
            {/* <p className="font-semibold text-xl text-white w-[100%]"> ***** </p>
            <p className="font-semibold text-xl text-white w-[100%]"> ***** </p> */}
            <p className="font-semibold text-sm text-white w-[100%]">Total  withdraw amount </p>
          </div>
        ...
        <div className=" bg-white  p-3  flex flex-col justify-between z-[1] w-[100%] rounded-2xl h-[240px] top-7 left-1 md:left-2">
          <div className="w-[100%] flex justify-between">
            <div className="flex flex-col ">
              <p className="text-sm font-medium ">{t(`Pending`)} {t(`Withdraw`)} {t(`Count`)}</p>
              <p className="text-lg font-bold  text-orange-400">{transactionCount?.pendingWithdrawCount}</p>
            </div>
            <svg
              width="116"
              height="71"
          ...
          <div className="flex flex-col items-start justify-evenly mt-4 w-[90%] m-auto">
            <p className="font-extrabold text-2xl  text-orange-400 w-[100%]"> &#x20B9; - {transactionData?.pendingWithdrawAmount} </p>
            {/* <p className="font-semibold text-xl text-white w-[100%]"> ***** </p>
            <p className="font-semibold text-xl text-white w-[100%]"> ***** </p> */}
            <p className="font-semibold text-sm  w-[100%]">Total pending withdraw amount </p>
          </div>
        </div>
                ...
                >
                  ...
                  <td>
                    <div className="flex flex-col text-center gap-[2px]">
                      ...
                      {/* <p className="text-xs    ">
                        {(item.withdraw_amount + item.bonus).toFixed(2)} {item?.currency}
                      </p> */}
                    </div>
                  </td>
                  <td className="">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex gap-3 w-[100%] items-center p-3 ">
                        <p className=" font-bold text-sm">Trx:-</p>
