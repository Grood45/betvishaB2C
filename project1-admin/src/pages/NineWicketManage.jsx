...
const NineWicketManage = () => {
    ...
    const getProviderSetup = useCallback(async () => {
        setFetching(true);
        let url = `${import.meta.env.VITE_API_URL}/api/sport/setup/9Wicket`;
        try {
    ...
    const testConnection = async () => {
        ...
        toast({
            ...
            description: `9Wicket Node responded in ${simulatedLatency}ms`,
            status: "success",
            duration: 3000,
            position: "top-right"
        });
                    ...
                    <VStack align="start" spacing={0}>
                        <Breadcrumb fontSize="xs" color="gray.500" separator={<FaChevronRight size={8} />}>
                            ...
                            <BreadcrumbItem isCurrentPage>
                                <BreadcrumbLink href="#">9Wicket</BreadcrumbLink>
                            </BreadcrumbItem>
                        </Breadcrumb>
                        <HStack spacing={3}>
                        ...
                        <VStack spacing={6} textAlign="center">
                            ...
                            <VStack spacing={2}>
                                ...
                                <Text fontSize="13px" color="gray.500" fontWeight="500" px={4} lineHeight="1.5">
                                    Your <Text as="span" fontWeight="800" color="gray.700">9WICKET</Text> configuration has been successfully synced.
                                </Text>
                            </VStack>
...
export default NineWicketManage;
