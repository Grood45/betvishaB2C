    ...
    return (
      <>
        <Button onClick={onOpen}  gap="15px" height="auto" fontSize="14px"  minW={{ base: "100%", xl: "100%" }} bg="transparent" _hover={{ bg: 'transparent', }} justifyContent="center">
          ...
          >
            <MdLock size={28} />
            <p className='text-black ' style={{color:"black"}}>{t(`Change`)}..</p>
          </Link>
        </Button>
        <Modal size={"full"} isOpen={isOpen} onClose={onClose}>
              <ModalOverlay />
              <ModalContent>
              <ModalHeader style={{textAlign:"center",fontSize:"16px"}}>Change Password</ModalHeader>
          <ModalCloseButton />

          <Flex flexDirection="column" style={{width:"100%"}}>
      <div className='w-[100%] mt-[10px]  my-3'  style={{width:"100%"}}>

        <Flex gap="10px" flexDirection="column" style={{ textAlign: 'left',width:"100%" }}>
          
          <div
            className="p-3 w-[100%] px-[15px] rounded-[5px]"
          >
