import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Grid, Spinner, Text } from "@chakra-ui/react";
...
const getPrivacyPoicy = async () => {
        ...
        try {
          let response = await axios.get(
            ...
            }/api/navigation/get-all-navigation?name=Terms Conditions&site_auth_key=${import.meta.env.VITE_API_SITE_AUTH_KEY}`,
            {
              headers: {
                token: data?.token,
